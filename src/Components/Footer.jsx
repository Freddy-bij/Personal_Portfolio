...
const Footer = () => {
  return (
    <div className=" bg-gray-500/10  rounded-xl font-[sofia] py-10 text-xl">
      ...
      <div className="w-[70%] mx-auto grid grid-cols-3 border-b-1  pb-10 ">
        ...
        <div>
          ...
          <ul className="pl-6 font-semibold  pt-2">
            <div className="flex items-center gap-2 pb-4">  <div className="w-8 h-8  bg-[#ff2f34] flex items-center justify-center rounded-full "><FaPhone /></div> <li className="hover:underline hover:underline-offset-6 hover:text-gray-500/60">+250792404909</li> </div>
            <div className="flex items-center gap-2 pb-4">  <div className="w-8 h-8  bg-[#ff2f34] flex items-center justify-center rounded-full "><MdEmail /></div><li className="hover:underline hover:underline-offset-6 hover:text-gray-500/60 ">freddybijanja31@gmail.com</li></div>
            <div className="flex items-center gap-2 ">  <div className="w-8 h-8  bg-[#ff2f34] flex items-center justify-center rounded-full "><FaLinkedinIn /></div><li className="hover:underline hover:underline-offset-6 hover:text-gray-500/60 "> freddy-bij</li></div>
          </ul>
        </div>
      </div>
